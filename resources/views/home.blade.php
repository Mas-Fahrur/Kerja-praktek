...
<section class="section-fitur reveal">
    <div class="fitur-grid">
        ...
        <div class="fitur-card reveal">
            ...
            <p>Penikmat kuliner dapat merasakan beragam menu pendamping seperti gorengan, hingga menu khas lainnya.</p>
        </div>
...
<section id="varianmenu" class="menu-section">
    ...
    <!-- Grid Menu -->
    <div class="menu-grid">
        <div class="menu-card reveal"><div class="menu-img img1"></div></div>
        <div class="menu-card reveal"><div class="menu-img img2"></div></div>
        <div class="menu-card reveal"><div class="menu-img img3"></div></div>
    </div>
...
<section class="location-section">
    ...
    <div class="location-right">
        <div class="map-box">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3955.063474939!2d110.817181!3d-7.565425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a168c89343fed%3A0x52a8b2ddb3f7e9a4!2sJl.%20Sukoreno%2C%20Kemlayan%2C%20Kec.%20Serengan%2C%20Kota%20Surakarta%2C%20Jawa%20Tengah%2057151!5e0!3m2!1sid!2sid!4v1737638000000!5m2!1sid!2sid" 
           width="100%" 
           height="100%" 
